# Terraform module for `ros2bag-fileserver-k8s`

This is a Terraform module facilitating the deployment of the `ros2bag-fileserver-k8s` charm,
...
| Name | Type |
|------|------|
| [juju_application.ros2bag_fileserver](https://registry.terraform.io/providers/juju/juju/latest/docs/resources/application) | resource |
...
| app\_name | Application name | `string` | `"ros2bag-fileserver"` | no |
